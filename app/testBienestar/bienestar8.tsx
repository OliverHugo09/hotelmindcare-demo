import {
  ...
  export default function BienestarPage8() {
    ...
    return (
      <ViewInset className="flex-1 bg-sky-600">
          <View>
              <Text className="text-xl font-medium text-center text-white">6. Disfruto haciendo planes para el futuro y trabajar para hacerlo realidad</Text>
          </View>
