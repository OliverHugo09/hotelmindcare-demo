import {
  ...
  export default function BienestarPage4() {
    ...
    return (
      <ViewInset className="flex-1 bg-sky-600">
          <View>
              <Text className="text-xl font-medium text-center text-white">2. A menudo me siento solo porque tengo pocos amigos íntimos con quienes compartir mis preocupaciones</Text>
          </View>
          ...
          <Link className="mb-10" href="/testBienestar/bienestar5" asChild>
