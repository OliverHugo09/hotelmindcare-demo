import {
  ...
  export default function BienestarPage7() {
    ...
    return (
      <ViewInset className="flex-1 bg-sky-600">
          <View>
              <Text className="text-xl font-medium text-center text-white">5. Me resulta difícil dirigir mi vida hacia un camino que me satisfaga</Text>
          </View>
          ...
          <Link className="mb-10" href="/testBienestar/bienestar8" asChild>
