import {
  ...
  export default function BienestarPage6() {
    ...
    return (
      <ViewInset className="flex-1 bg-sky-600">
          <View>
              <Text className="text-xl font-medium text-center text-white">4. Me preocupa como otra gente evalúa las elecciones que he hecho en mi vida</Text>
          </View>
          ...
          <Link className="mb-10" href="/testBienestar/bienestar7" asChild>
